...
const ITEM_IDS = [
  ...
  "winters-approach","yordle-trap","youmuus-ghostblade","zekes-convergence","Protobelt","LichBane","Whispering-Circlet","Diadem-of-songs","echoes-of-helia","mantle-of-the-twelfth-hour","Shurelya's Battlesong",
];
