...
export function ChampionTierListPage({ champions, editMode, setEditMode, onUpdate, syncStatus, auth, currentPatch, onUpdatePatch }) {
  ...
  return (
    <section className="page-section">
      <div className="wrap">
        ...
        <CoachToggle editMode={editMode} setEditMode={setEditMode} syncStatus={syncStatus} auth={auth} currentPatch={currentPatch} onUpdatePatch={onUpdatePatch} />
 ...
 *  happen once. */
function FilterableTierListPage({ title, subtitle, entries: rawEntries, categories, iconMap, colorMap, getTag, editMode, setEditMode, onUpdate, syncStatus, auth, currentPatch, onUpdatePatch, _type }) {
...
export function ItemTierListPage({ items, editMode, setEditMode, onUpdate, syncStatus, auth, currentPatch, onUpdatePatch }) {
  return (
...
export function RuneTierListPage({ runes, editMode, setEditMode, onUpdate, syncStatus, auth, currentPatch, onUpdatePatch }) {
  return (
    <FilterableTierListPage
