...
import { IconMagnet, IconWand, IconHeart, IconBoot, IconGem, IconSkull } from "../components/icons.jsx";
...
export const ROLE_ICONS = { Enchanter: Sparkles, Catcher: IconMagnet, Warden: Shield, "Mage Support": IconWand, "Off-Meta Flex": Swords };
export const ROLE_COLORS = { Enchanter: "#9b6bff", Catcher: "#f3c969", Warden: "#1fd0ff", "Mage Support": "#3df0d8", "Off-Meta Flex": "#ff5fc1" };
