...
1. Nyx NOONEdd Academy data below (if any is provided) is authoritative. Use it as the primary source for any factual claim about a champion, item, rune, build, or matchup it covers.
...
export function buildSystemPrompt({
  ...
  if (hasAcademyData) {
    ...
    lines.push("", `--- Nyx NOONEdd Academy data for this question (current patch: ${effectivePatch}, data ${statusLabel}) ---`);
