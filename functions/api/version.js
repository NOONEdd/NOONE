...
export async function onRequestGet(context) {
  ...
  const patchDataStatus = resolvePatchDataStatus(overrides, patch);
  return new Response(JSON.stringify({ provider, model, providerImplemented: implemented, patch, patchDataStatus: patchDataStatus.status }), {
    status: 200,
