...
{tag: "hard into", name: "high mobility champions or dissengagers and enchanters like janna or karma."},
   ...
   { id: "Morgana", name: "Morgana", role: "Off-Meta Flex", tier: "C", blurb: "Her ability to disable enemies and control the battlefield makes her a valuable support champion. Worth knowing: every current source describes her as primarily a jungler, not an established support — treat this as an experimental pick until there's real match data to back it, not a settled recommendation.",
    builds: [
    {
    name: "tanky support",
    items: [
  ...
  matchups: [
{tag: "hard into", name: "high mobility champions like assassins or high poke damage dealers  like orianna or karma."},
